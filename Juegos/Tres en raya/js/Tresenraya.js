...
function aplicarTraduccionesEstaticas() {
    ...
    if (lblTitulo) {
        lblTitulo.textContent = obtenerTextoTraduccion("titulo_tres_en_raya", "Tres en raya");
    }

    const btnClasico = document.getElementById("btn-modo-clasico");
    if (btnClasico) {
        btnClasico.textContent = obtenerTextoTraduccion("btn_clasico", "Clásico");
    }

    const btnMovimiento = document.getElementById("btn-modo-movimiento");
    if (btnMovimiento) {
        btnMovimiento.textContent = obtenerTextoTraduccion("btn_tres_en_movimiento", "Tres en movimiento");
    }
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en Tres en raya:", error);
    }
    ...
    if (btnClasico) {
        btnClasico.addEventListener("click", () => {
            window.location.href = "Clásico.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en Tres en raya:", error);
    }
