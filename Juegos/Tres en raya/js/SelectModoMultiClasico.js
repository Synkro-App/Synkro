...
const traduccionesLocales = {
    "titulo_select_modo_multijugador": {
        "es": "Seleccionar Modo Multijugador",
        "en": "Select Multiplayer Mode",
        "fr": "Sélectionner le mode multijoueur",
        "ro": "Selectați modul multiplayer"
    },
    "btn_jugar_y_pasar": {
        "es": "Jugar y pasar",
        "en": "Play and pass",
...
function aplicarTraduccionesEstaticas() {
    ...
    if (lblTitulo) {
        lblTitulo.textContent = obtenerTextoTraduccion("titulo_select_modo_multijugador", "Seleccionar Modo Multijugador");
    }

    const btnJugarPasar = document.getElementById("btn-jugar-y-pasar");
    if (btnJugarPasar) {
        btnJugarPasar.textContent = obtenerTextoTraduccion("btn_jugar_y_pasar", "Jugar y pasar");
    }

    const btnConAmigo = document.getElementById("btn-con-amigo");
    if (btnConAmigo) {
        btnConAmigo.textContent = obtenerTextoTraduccion("btn_con_amigo", "Con amigo");
    }

    const btnAleatorio = document.getElementById("btn-aleatorio");
    if (btnAleatorio) {
        btnAleatorio.textContent = obtenerTextoTraduccion("btn_aleatorio", "Aleatorio");
    }
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en SelectModoMultiClasico:", error);
    }
    ...
    // --- CONFIGURACIÓN DE BOTONES DE MODO MULTIJUGADOR ---
    const btnJugarPasar = document.getElementById("btn-jugar-y-pasar");
    if (btnJugarPasar) {
        btnJugarPasar.addEventListener("click", () => {
            window.location.href = "salapasarclasico.html";
        });
    }
    ...
    if (btnConAmigo) {
        btnConAmigo.addEventListener("click", () => {
            window.location.href = "salaamigoclasico.html";
        });
    }
    ...
    if (btnAleatorio) {
        btnAleatorio.addEventListener("click", () => {
            window.location.href = "salaaleatorioclasico.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en SelectModoMultiClasico:", error);
    }
