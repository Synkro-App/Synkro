...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en SelectDificultadTres:", error);
    }
    ...
    if (btnFacil) {
        btnFacil.addEventListener("click", () => {
            window.location.href = "iafaciltres.html";
        });
    }
    ...
    if (btnMedio) {
        btnMedio.addEventListener("click", () => {
            window.location.href = "iamediotres.html";
        });
    }
    ...
    if (btnDificil) {
        btnDificil.addEventListener("click", () => {
            window.location.href = "iadificiltres.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en SelectDificultadTres:", error);
    }
