...
function aplicarTraduccionesEstaticas() {
    ...
    if (lblTitulo) {
        lblTitulo.textContent = obtenerTextoTraduccion("titulo_select_modo", "Seleccionar Modo");
    }

    const btnJugarYPasar = document.getElementById("btn_jugar_y_pasar");
    if (btnJugarYPasar) {
        btnJugarYPasar.textContent = obtenerTextoTraduccion("btn_jugar_y_pasar", "Jugar y pasar");
    }

    const btnConAmigo = document.getElementById("btn_con_amigo");
    if (btnConAmigo) {
        btnConAmigo.textContent = obtenerTextoTraduccion("btn_con_amigo", "Con amigo");
    }

    const btnAleatorio = document.getElementById("btn_aleatorio");
    if (btnAleatorio) {
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en SelectModoTres:", error);
    }
    ...
    const btnJugarYPasar = document.getElementById("btn_jugar_y_pasar");
    if (btnJugarYPasar) {
        btnJugarYPasar.addEventListener("click", () => {
            window.location.href = "salapasartres.html";
        });
    }
    ...
    if (btnConAmigo) {
        btnConAmigo.addEventListener("click", () => {
            window.location.href = "salaamigotres.html";
        });
    }
    ...
    if (btnAleatorio) {
        btnAleatorio.addEventListener("click", () => {
            window.location.href = "salaaleatoriotres.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en SelectModoTres:", error);
    }
