...
function aplicarTraduccionesEstaticas() {
    ...
    if (lblTitulo) {
        lblTitulo.textContent = obtenerTextoTraduccion("btn_clasico", "Clásico");
    }
    ...
    const btnMultijugador = document.getElementById("btn-modo-multijugador");
    if (btnMultijugador) {
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en Clásico:", error);
    }
    ...
    // --- CONFIGURACIÓN DE BOTONES DE MODO DE JUEGO ---
    const btnIa = document.getElementById("btn-modo-ia");
    if (btnIa) {
        btnIa.addEventListener("click", () => {
            window.location.href = "selectdificultadiaclasico.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en Clásico:", error);
    }
