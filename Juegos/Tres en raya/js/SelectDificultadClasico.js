...
const traduccionesLocales = {
    "titulo_select_dificultad": {
        "es": "Seleccionar Dificultad",
        "en": "Select Difficulty",
        "fr": "Sélectionner la difficulté",
        "ro": "Selectați dificultatea"
    },
    "btn_facil": {
        "es": "Fácil",
        "en": "Easy",
...
function aplicarTraduccionesEstaticas() {
    ...
    if (lblTitulo) {
        lblTitulo.textContent = obtenerTextoTraduccion("titulo_select_dificultad", "Seleccionar Dificultad");
    }

    const btnFacil = document.getElementById("btn-facil");
    if (btnFacil) {
        btnFacil.textContent = obtenerTextoTraduccion("btn_facil", "Fácil");
    }

    const btnMedio = document.getElementById("btn-medio");
    if (btnMedio) {
        btnMedio.textContent = obtenerTextoTraduccion("btn_medio", "Medio");
    }

    const btnDificil = document.getElementById("btn-dificil");
    if (btnDificil) {
        btnDificil.textContent = obtenerTextoTraduccion("btn_dificil", "Difícil");
    }
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        console.error("Error cargando idiomas.json en SelectDificultadClasico:", error);
    }
    ...
    if (btnFacil) {
        btnFacil.addEventListener("click", () => {
            window.location.href = "iafacilclasico.html";
        });
    }
    ...
    if (btnMedio) {
        btnMedio.addEventListener("click", () => {
            window.location.href = "iamedioclasico.html";
        });
    }
    ...
    if (btnDificil) {
        btnDificil.addEventListener("click", () => {
            window.location.href = "iadificilclasico.html";
        });
    }
    ...
    try {
        ...
        console.error("Error al obtener los datos del usuario en SelectDificultadClasico:", error);
    }
