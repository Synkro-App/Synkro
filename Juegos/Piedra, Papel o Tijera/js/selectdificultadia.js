...
const traduccionesLocales = {
    ...
    "seleccionar_dificultad": { "es": "Seleccionar Dificultad", "en": "Select Difficulty", "fr": "Sélectionner la difficulté", "ro": "Selectați Dificultatea" },
...
function aplicarTraduccionesEstaticas() {
    ...
    if (tituloDificultad) tituloDificultad.textContent = obtenerTextoTraduccion("seleccionar_dificultad", "Seleccionar Dificultad");
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (btnFacil) {
        btnFacil.addEventListener("click", () => {
            window.location.href = "iafacil.html";
        });
    }
    ...
    if (btnMedio) {
        btnMedio.addEventListener("click", () => {
            window.location.href = "iamedio.html";
        });
    }
    ...
    if (btnDificil) {
        btnDificil.addEventListener("click", () => {
            window.location.href = "iadificil.html";
        });
    }
