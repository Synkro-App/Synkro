...
const traduccionesLocales = {
    ...
    "selectmode_titulo": { "es": "Seleccionar Modo", "en": "Select Mode", "fr": "Sélectionner le mode", "ro": "Selectați modul" },
    "jugar_pasar": { "es": "Jugar y pasar", "en": "Play and pass", "fr": "Jouer et passer", "ro": "Joacă și treci" },
    "jugar_amigo": { "es": "Jugar con amigo", "en": "Play with friend", "fr": "Jouer avec un ami", "ro": "Joacă cu un prieten" },
    "aleatorio": { "es": "Aleatorio", "en": "Random", "fr": "Aléatoire", "ro": "Aleatoriu" }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelectMode = document.getElementById("titulo-selectmode");
    if (tituloSelectMode) tituloSelectMode.textContent = obtenerTextoTraduccion("selectmode_titulo", "Seleccionar Modo");
    
    const btnJugarPasar = document.getElementById("btn-jugar-pasar");
    if (btnJugarPasar) btnJugarPasar.textContent = obtenerTextoTraduccion("jugar_pasar", "Jugar y pasar");
    
    const btnJugarAmigo = document.getElementById("btn-jugar-amigo");
    if (btnJugarAmigo) btnJugarAmigo.textContent = obtenerTextoTraduccion("jugar_amigo", "Jugar con amigo");
    
    const btnAleatorio = document.getElementById("btn-aleatorio");
    if (btnAleatorio) btnAleatorio.textContent = obtenerTextoTraduccion("aleatorio", "Aleatorio");
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const btnJugarPasar = document.getElementById("btn-jugar-pasar");
    if (btnJugarPasar) btnJugarPasar.addEventListener("click", () => { window.location.href = "salapasar.html"; });

    const btnJugarAmigo = document.getElementById("btn-jugar-amigo");
    if (btnJugarAmigo) btnJugarAmigo.addEventListener("click", () => { window.location.href = "salaamigo.html"; });

    const btnAleatorio = document.getElementById("btn-aleatorio");
    if (btnAleatorio) btnAleatorio.addEventListener("click", () => { window.location.href = "salaaleatorio.html"; });
