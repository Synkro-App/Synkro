...
const traduccionesLocales = {
    ...
    "ia_facil_titulo": { "es": "Piedra, Papel o Tijera - Fácil", "en": "Rock, Paper, Scissors - Easy", "fr": "Pierre, Papier, Ciseaux - Facile", "ro": "Piatră, Hârtie sau Foarfece - Ușor" },
    ...
    "ganas": { "es": "¡Has ganado! 🎉 (+5 NovaPoints)", "en": "You win! 🎉 (+5 NovaPoints)", "fr": "Vous avez gagné! 🎉 (+5 NovaPoints)", "ro": "Ai câștigat! 🎉 (+5 NovaPoints)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIaFacil = document.getElementById("titulo-iafacil");
    if (tituloIaFacil) tituloIaFacil.textContent = obtenerTextoTraduccion("ia_facil_titulo", "Piedra, Papel o Tijera - Fácil");
...
function jugar(eleccionUsuario) {
    ...
    if (eleccionUsuario === eleccionIa) {
        ...
        if (txtResultado) txtResultado.textContent = obtenerTextoTraduccion("ganas", "¡Has ganado! (+5 NovaPoints)");
        scoreUsuario++;
