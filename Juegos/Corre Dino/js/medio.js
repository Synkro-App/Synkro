...
const traduccionesLocales = {
    ...
    "titulo_medio": { "es": "Corre Dino - Medio", "en": "Dino Run - Medium", "fr": "Course Dino - Moyen", "ro": "Fugi Dino - Mediu" }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    if (tituloMedio) tituloMedio.textContent = obtenerTextoTraduccion("titulo_medio", "Corre Dino - Medio");
}

// --- LÓGICA DEL JUEGO: DINO RUN (MODO MEDIO) ---
function inicializarJuegoDino() {
    ...
    let totalAgachos = 0;
    let totalMonedas = 0;
    let gameSpeed = 6; // Velocidad ajustada para el modo medio (ni muy rápido, ni tan lento)[cite: 17]
    ...
    async function finalizarPartidaYGuardarRecompensas() {
        ...
        try {
            ...
            // Documento de transacción con el campo modo: "medio" incluido
