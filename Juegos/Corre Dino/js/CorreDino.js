...
const traduccionesLocales = {
    ...
    "titulo_oredino": { "es": "Corre Dino", "en": "Dino Run", "fr": "Course Dino", "ro": "Fugi Dino" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloOredino = document.getElementById("titulo-oredino");
    if (tituloOredino) tituloOredino.textContent = obtenerTextoTraduccion("titulo_oredino", "Corre Dino");
