...
const traduccionesLocales = {
    ...
    "titulo_medio_2m": { "es": "Medio - 2 Minutos", "en": "Medium - 2 Minutes", "fr": "Moyen - 2 Minutes", "ro": "Mediu - 2 Minute" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloMedio2m = document.getElementById("titulo-medio-2m");
    if (tituloMedio2m) tituloMedio2m.textContent = obtenerTextoTraduccion("titulo_medio_2m", "Medio - 2 Minutos");
...
async function finalizarJuegoExitoso() {
    ...
    const novasGanadas = parejasEncontradas * 10; // 10 NovaPoints por cada pareja
...
async function finalizarJuegoPorTiempo() {
    ...
    const novasGanadas = parejasEncontradas * 10; // 10 NovaPoints por cada pareja encontrada
