...
const traduccionesLocales = {
    ...
    "titulo_ia3_dificil": { "es": "Memoria - 3 IAs (Difícil)", "en": "Memory - 3 AIs (Hard)", "fr": "Mémoire - 3 IAs (Difficile)", "ro": "Memorie - 3 IA (Greu)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIa3Dificil = document.getElementById("titulo-ia3-dificil");
    if (tituloIa3Dificil) tituloIa3Dificil.textContent = obtenerTextoTraduccion("titulo_ia3_dificil", "Memoria - 3 IAs (Difícil)");
