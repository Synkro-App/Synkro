...
const traduccionesLocales = {
    ...
    "titulo_dificil_1m": { "es": "Difícil - 1 Minuto", "en": "Hard - 1 Minute", "fr": "Difficile - 1 Minute", "ro": "Dificil - 1 Minut" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloDificil1m = document.getElementById("titulo-dificil-1m");
    if (tituloDificil1m) tituloDificil1m.textContent = obtenerTextoTraduccion("titulo_dificil_1m", "Difícil - 1 Minuto");
...
async function finalizarJuegoExitoso() {
    ...
    const novasGanadas = parejasEncontradas * 20; // 20 NovaPoints por cada pareja
...
async function finalizarJuegoPorTiempo() {
    ...
    const novasGanadas = parejasEncontradas * 20; // 20 NovaPoints por cada pareja encontrada
