...
const traduccionesLocales = {
    ...
    "titulo_select_sintiempo": { "es": "Sin Tiempo", "en": "No Time Limit", "fr": "Sans Temps", "ro": "Fără Timp" },
    "facil": { "es": "Fácil", "en": "Easy", "fr": "Facile", "ro": "Ușor" },
    "medio": { "es": "Medio", "en": "Medium", "fr": "Moyen", "ro": "Mediu" },
    "dificil": { "es": "Difícil", "en": "Hard", "fr": "Difficile", "ro": "Greu" }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelectSinTiempo = document.getElementById("titulo-select-sintiempo");
    if (tituloSelectSinTiempo) tituloSelectSinTiempo.textContent = obtenerTextoTraduccion("titulo_select_sintiempo", "Sin Tiempo");
    
    const btnFacil = document.getElementById("btn-facil");
    if (btnFacil) btnFacil.textContent = obtenerTextoTraduccion("facil", "Fácil");

    const btnMedio = document.getElementById("btn-medio");
    if (btnMedio) btnMedio.textContent = obtenerTextoTraduccion("medio", "Medio");

    const btnDificil = document.getElementById("btn-dificil");
    if (btnDificil) btnDificil.textContent = obtenerTextoTraduccion("dificil", "Difícil");
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (btnFacil) {
        btnFacil.addEventListener("click", () => {
            window.location.href = "solofacil.html";
        });
    }
    ...
    if (btnMedio) {
        btnMedio.addEventListener("click", () => {
            window.location.href = "solomedio.html";
        });
    }
    ...
    if (btnDificil) {
        btnDificil.addEventListener("click", () => {
            window.location.href = "solodificil.html";
        });
    }
