...
const traduccionesLocales = {
    ...
    "titulo_ia3_medio": { "es": "Memoria - 3 IAs (Medio)", "en": "Memory - 3 AIs (Medium)", "fr": "Mémoire - 3 IAs (Moyen)", "ro": "Memorie - 3 IA (Mediu)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIa3Medio = document.getElementById("titulo-ia3-medio");
    if (tituloIa3Medio) tituloIa3Medio.textContent = obtenerTextoTraduccion("titulo_ia3_medio", "Memoria - 3 IAs (Medio)");
...
function totalParejasEncontradas() {
    return parejasUsuario + parejasIA1 + parejasIA2 + parejasIA3;
}
...
async function finalizarPartida() {
    ...
    if (currentLanguage === "en") {
        textoResultado = `Game over! You: ${parejasUsuario} | IA 1: ${parejasIA1} | IA 2: ${parejasIA2} | IA 3: ${parejasIA3}`;
    } else {
        textoResultado = `¡Partida finalizada! Usuario: ${parejasUsuario} - IA 1: ${parejasIA1} - IA 2: ${parejasIA2} - IA 3: ${parejasIA3}`;
    }
