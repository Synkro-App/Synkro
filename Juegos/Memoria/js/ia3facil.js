...
const traduccionesLocales = {
    ...
    "titulo_ia3_facil": { "es": "Memoria - 3 IAs (Fácil)", "en": "Memory - 3 AIs (Easy)", "fr": "Mémoire - 3 IAs (Facile)", "ro": "Memorie - 3 IA (Ușor)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIa3Facil = document.getElementById("titulo-ia3-facil");
    if (tituloIa3Facil) tituloIa3Facil.textContent = obtenerTextoTraduccion("titulo_ia3_facil", "Memoria - 3 IAs (Fácil)");
