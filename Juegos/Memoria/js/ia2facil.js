...
const traduccionesLocales = {
    ...
    "titulo_ia2_facil": { "es": "Memoria - Contra 2 IAs (Fácil)", "en": "Memory - Against 2 AIs (Easy)", "fr": "Mémoire - Contre 2 IAs (Facile)", "ro": "Memorie - Contra 2 IA (Ușor)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIa2Facil = document.getElementById("titulo-ia2-facil");
    if (tituloIa2Facil) tituloIa2Facil.textContent = obtenerTextoTraduccion("titulo_ia2_facil", "Memoria - Contra 2 IAs (Fácil)");
        ...
        setTimeout(() => {
            ...
            if (esCoincidencia) {
                ...
                if (parejasUsuario + parejasIA1 + parejasIA2 === totalParejas) {
                    ...
                    setTimeout(turnoIA1, 1000); // IA1 repite si acierta
                }
            } else {
        ...
        setTimeout(() => {
            ...
            if (esCoincidencia) {
                ...
                if (parejasUsuario + parejasIA1 + parejasIA2 === totalParejas) {
                    ...
                    setTimeout(turnoIA2, 1000); // IA2 repite si acierta
                }
            } else {
                carta1.classList.remove("flipped");
                carta1.textContent = "";
