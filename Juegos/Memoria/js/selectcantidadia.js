...
const traduccionesLocales = {
    ...
    "titulo_select_cantidad": { "es": "Seleccionar Oponentes IA", "en": "Select AI Opponents", "fr": "Sélectionner des adversaires IA", "ro": "Selectați Oponenți IA" },
    "btn_contra_1": { "es": "Contra 1", "en": "Against 1", "fr": "Contre 1", "ro": "Contra 1" },
    "btn_contra_2": { "es": "Contra 2", "en": "Against 2", "fr": "Contre 2", "ro": "Contra 2" },
    "btn_contra_3": { "es": "Contra 3", "en": "Against 3", "fr": "Contre 3", "ro": "Contra 3" },
    "btn_contra_4": { "es": "Contra 4", "en": "Against 4", "fr": "Contre 4", "ro": "Contra 4" }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelect = document.getElementById("titulo-select-cantidad");
    if (tituloSelect) tituloSelect.textContent = obtenerTextoTraduccion("titulo_select_cantidad", "Seleccionar Oponentes IA");

    const btn1 = document.getElementById("btn-contra-1");
    if (btn1) btn1.textContent = obtenerTextoTraduccion("btn_contra_1", "Contra 1");

    const btn2 = document.getElementById("btn-contra-2");
    if (btn2) btn2.textContent = obtenerTextoTraduccion("btn_contra_2", "Contra 2");

    const btn3 = document.getElementById("btn-contra-3");
    if (btn3) btn3.textContent = obtenerTextoTraduccion("btn_contra_3", "Contra 3");

    const btn4 = document.getElementById("btn-contra-4");
    if (btn4) btn4.textContent = obtenerTextoTraduccion("btn_contra_4", "Contra 4");
}
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de oponentes IA
    const btnContra1 = document.getElementById("btn-contra-1");
    if (btnContra1) btnContra1.addEventListener("click", () => { window.location.href = "select1iamode.html"; });

    const btnContra2 = document.getElementById("btn-contra-2");
    if (btnContra2) btnContra2.addEventListener("click", () => { window.location.href = "select2iamode.html"; });

    const btnContra3 = document.getElementById("btn-contra-3");
    if (btnContra3) btnContra3.addEventListener("click", () => { window.location.href = "select3iamode.html"; });

    const btnContra4 = document.getElementById("btn-contra-4");
    if (btnContra4) btnContra4.addEventListener("click", () => { window.location.href = "select4iamode.html"; });
