...
// Emojis disponibles (al menos 10 para cubrir las 10 parejas del modo medio)
...
const traduccionesLocales = {
    ...
    "titulo_solo_medio": { "es": "Memoria - Medio", "en": "Memory - Medium", "fr": "Mémoire - Moyen", "ro": "Memorie - Mediu" },
    "btn_reiniciar": { "es": "Volver a jugar", "en": "Play again", "fr": "Rejouer", "ro": "Joacă din nou" },
    "victoria_msg": { 
        "es": "¡Felicidades! Has completado el juego y ganado 50 NovaPoints.", 
        "en": "Congratulations! You completed the game and won 50 NovaPoints.", 
        "fr": "Félicitations! Vous avez gagné 50 NovaPoints.", 
        "ro": "Felicitări! Ai câștigat 50 NovaPoints." 
    }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSoloMedio = document.getElementById("titulo-solo-medio");
    if (tituloSoloMedio) tituloSoloMedio.textContent = obtenerTextoTraduccion("titulo_solo_medio", "Memoria - Medio");

    const btnReiniciar = document.getElementById("btn-reiniciar");
    if (btnReiniciar) btnReiniciar.textContent = obtenerTextoTraduccion("btn_reiniciar", "Volver a jugar");
}

// Lógica del juego de Memoria (10 parejas)
...
async function finalizarJuegoExitoso() {
    ...
    mensajeDiv.textContent = obtenerTextoTraduccion("victoria_msg", "¡Felicidades! Has completado el juego y ganado 50 NovaPoints.");
    ...
    if (userDocIdGlobal) {
        try {
            ...
            // Guardar el documento de la transacción con modo solomedio y 50 NovaPoints
