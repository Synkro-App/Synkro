...
const traduccionesLocales = {
    ...
    "titulo_select_2ia": { "es": "Contra 2 IA - Seleccionar Dificultad", "en": "Against 2 AI - Select Difficulty", "fr": "Contre 2 IA - Sélectionner la difficulté", "ro": "Contra 2 IA - Selectați Dificultatea" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelect = document.getElementById("titulo-select-2ia");
    if (tituloSelect) tituloSelect.textContent = obtenerTextoTraduccion("titulo_select_2ia", "Contra 2 IA - Seleccionar Dificultad");
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de dificultad contra 2 IA
    const btnIaFacil = document.getElementById("btn-ia-facil");
    if (btnIaFacil) btnIaFacil.addEventListener("click", () => { window.location.href = "ia2facil.html"; });

    const btnIaMedio = document.getElementById("btn-ia-medio");
    if (btnIaMedio) btnIaMedio.addEventListener("click", () => { window.location.href = "ia2medio.html"; });

    const btnIaDificil = document.getElementById("btn-ia-dificil");
    if (btnIaDificil) btnIaDificil.addEventListener("click", () => { window.location.href = "ia2dificil.html"; });
