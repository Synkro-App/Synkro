...
const traduccionesLocales = {
    ...
    "titulo_select_1ia": { "es": "Contra 1 IA - Seleccionar Dificultad", "en": "Against 1 AI - Select Difficulty", "fr": "Contre 1 IA - Sélectionner la difficulté", "ro": "Contra 1 IA - Selectați Dificultatea" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelect = document.getElementById("titulo-select-1ia");
    if (tituloSelect) tituloSelect.textContent = obtenerTextoTraduccion("titulo_select_1ia", "Contra 1 IA - Seleccionar Dificultad");
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de dificultad contra 1 IA
    const btnIaFacil = document.getElementById("btn-ia-facil");
    if (btnIaFacil) btnIaFacil.addEventListener("click", () => { window.location.href = "ia1facil.html"; });

    const btnIaMedio = document.getElementById("btn-ia-medio");
    if (btnIaMedio) btnIaMedio.addEventListener("click", () => { window.location.href = "ia1medio.html"; });

    const btnIaDificil = document.getElementById("btn-ia-dificil");
    if (btnIaDificil) btnIaDificil.addEventListener("click", () => { window.location.href = "ia1dificil.html"; });
