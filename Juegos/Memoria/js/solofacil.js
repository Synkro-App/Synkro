...
// Emojis disponibles para las parejas de memoria
...
const traduccionesLocales = {
    ...
    "titulo_solo_facil": { "es": "Memoria - Fácil", "en": "Memory - Easy", "fr": "Mémoire - Facile", "ro": "Memorie - Ușor" },
    "btn_reiniciar": { "es": "Volver a jugar", "en": "Play again", "fr": "Rejouer", "ro": "Joacă din nou" },
    "victoria_msg": { 
        "es": "¡Felicidades! Has completado el juego y ganado 20 NovaPoints.", 
        "en": "Congratulations! You completed the game and won 20 NovaPoints.", 
        "fr": "Félicitations! Vous avez gagné 20 NovaPoints.", 
        "ro": "Felicitări! Ai câștigat 20 NovaPoints." 
    }
};
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSoloFacil = document.getElementById("titulo-solo-facil");
    if (tituloSoloFacil) tituloSoloFacil.textContent = obtenerTextoTraduccion("titulo_solo_facil", "Memoria - Fácil");
...
async function finalizarJuegoExitoso() {
    ...
    mensajeDiv.textContent = obtenerTextoTraduccion("victoria_msg", "¡Felicidades! Has completado el juego y ganado 20 NovaPoints.");
    ...
    if (userDocIdGlobal) {
        try {
            ...
            // Referencia a la subcolección correcta "Transacciones de NovaPoints"
            ...
            // Guardar el documento de la transacción con setDoc asegurando la ruta completa
