...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de modo de juego (apuntando a las salas 4)
    const btnJugarPasar = document.getElementById("btn-jugar-pasar");
    if (btnJugarPasar) {
        btnJugarPasar.addEventListener("click", () => {
            window.location.href = "salajugarypasar4.html";
        });
    }
    ...
    if (btnConAmigo) {
        btnConAmigo.addEventListener("click", () => {
            window.location.href = "salaamigo4.html";
        });
    }
    ...
    if (btnAleatorio) {
        btnAleatorio.addEventListener("click", () => {
            window.location.href = "salaaleatorio4.html";
        });
    }
