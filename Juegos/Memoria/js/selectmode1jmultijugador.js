...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de modo de juego
    const btnJugarPasar = document.getElementById("btn-jugar-pasar");
    if (btnJugarPasar) {
        btnJugarPasar.addEventListener("click", () => {
            window.location.href = "salajugarypasar1.html";
        });
    }
    ...
    if (btnConAmigo) {
        btnConAmigo.addEventListener("click", () => {
            window.location.href = "salaamigo1.html";
        });
    }
    ...
    if (btnAleatorio) {
        btnAleatorio.addEventListener("click", () => {
            window.location.href = "salaaleatorio1.html";
        });
    }
