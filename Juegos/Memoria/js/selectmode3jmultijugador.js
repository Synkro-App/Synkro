...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de modo de juego (apuntando a las salas 3)
    const btnJugarPasar = document.getElementById("btn-jugar-pasar");
    if (btnJugarPasar) {
        btnJugarPasar.addEventListener("click", () => {
            window.location.href = "salajugarypasar3.html";
        });
    }
    ...
    if (btnConAmigo) {
        btnConAmigo.addEventListener("click", () => {
            window.location.href = "salaamigo3.html";
        });
    }
    ...
    if (btnAleatorio) {
        btnAleatorio.addEventListener("click", () => {
            window.location.href = "salaaleatorio3.html";
        });
    }
