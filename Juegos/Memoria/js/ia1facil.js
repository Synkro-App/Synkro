...
const traduccionesLocales = {
    ...
    "titulo_ia1_facil": { "es": "Memoria - Contra IA (Fácil)", "en": "Memory - Against AI (Easy)", "fr": "Mémoire - Contre IA (Facile)", "ro": "Memorie - Contra IA (Ușor)" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloIa1Facil = document.getElementById("titulo-ia1-facil");
    if (tituloIa1Facil) tituloIa1Facil.textContent = obtenerTextoTraduccion("titulo_ia1_facil", "Memoria - Contra IA (Fácil)");
