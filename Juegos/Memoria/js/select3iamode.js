...
const traduccionesLocales = {
    ...
    "titulo_select_3ia": { "es": "Contra 3 IA - Seleccionar Dificultad", "en": "Against 3 AI - Select Difficulty", "fr": "Contre 3 IA - Sélectionner la difficulté", "ro": "Contra 3 IA - Selectați Dificultatea" },
...
function aplicarTraduccionesEstaticas() {
    ...
    const tituloSelect = document.getElementById("titulo-select-3ia");
    if (tituloSelect) tituloSelect.textContent = obtenerTextoTraduccion("titulo_select_3ia", "Contra 3 IA - Seleccionar Dificultad");
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    // Enlaces de los botones de dificultad contra 3 IA
    const btnIaFacil = document.getElementById("btn-ia-facil");
    if (btnIaFacil) btnIaFacil.addEventListener("click", () => { window.location.href = "ia3facil.html"; });

    const btnIaMedio = document.getElementById("btn-ia-medio");
    if (btnIaMedio) btnIaMedio.addEventListener("click", () => { window.location.href = "ia3medio.html"; });

    const btnIaDificil = document.getElementById("btn-ia-dificil");
    if (btnIaDificil) btnIaDificil.addEventListener("click", () => { window.location.href = "ia3dificil.html"; });
